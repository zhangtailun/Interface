...
L["S_MAPBAR_OPTIONSMENU_ZONE_QUESTSUMMARY"] = "Show Quest Summary"
...
L["S_MAPFRAME_ALIGN_DESC"] = "|cFF22FF22Click|r to toggle the map frame anchor from left to center, center to left of the screen."
L["S_MAPFRAME_ALIGN_LEFT"] = "left"
L["S_OPTIONS_MAPFRAME_ALIGN"] = "Map Frame Centralized"
L["S_OPTIONS_MAPFRAME_ERROR_SCALING_DISABLED"] = "You need to enable 'Map Frame Scale' first, no value has changed."
L["S_OPTIONS_MAPFRAME_SCALE"] = "Map Frame Scale"
L["S_OPTIONS_MAPFRAME_SCALE_ENABLED"] = "Enable Frame Scaling"
...
Click |cFFFFAA11Toggle World Quests|r to hide quest locations.]=]
