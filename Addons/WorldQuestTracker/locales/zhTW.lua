...
L["S_MAPBAR_OPTIONSMENU_ZONE_QUESTSUMMARY"] = "顯示任務摘要"
...
L["S_MAPFRAME_ALIGN_DESC"] = "|cFF22FF22點一下|r切換地圖框架對齊畫面的中間或左側。"
L["S_MAPFRAME_ALIGN_LEFT"] = "左側"
L["S_OPTIONS_MAPFRAME_ALIGN"] = "地圖框架對齊中間"
L["S_OPTIONS_MAPFRAME_ERROR_SCALING_DISABLED"] = "尚未變更任何數值，必須先啟用 '地圖框架縮放大小'。 "
L["S_OPTIONS_MAPFRAME_SCALE"] = "地圖框架縮放大小"
L["S_OPTIONS_MAPFRAME_SCALE_ENABLED"] = "啟用框架縮放"
--[[Translation missing --]]
...
L["S_OPTIONS_WORLD_DECREASEICONSPERROW"] = "減少每列的方塊數量"
L["S_OPTIONS_WORLD_INCREASEICONSPERROW"] = "增加每列的方塊數量"
