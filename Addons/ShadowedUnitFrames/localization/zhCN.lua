...
L["Only apply the selected filters to buffs on friendly units and debuffs on hostile units, and otherwise show all auras."] = "仅应用所选过滤器到友好单位的Buff上和敌对单位的Debuff上，其他的显示所有光环。"
