...
--> global name declaration
		...
		_detalhes.build_counter = 7102
		_detalhes.alpha_build_counter = 7102 --if this is higher than the regular counter, use it instead
		_detalhes.game_version = "v8.1.5"
		_detalhes.userversion = "v8.1.5." .. _detalhes.build_counter
		_detalhes.realversion = 139 --core version, this is used to check API version for scripts and plugins (see alias below)
